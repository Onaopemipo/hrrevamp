...
import { LoanRepaymentLog, ServiceProxy, UpdateLoadRequestDTO } from './../../../_services/service-proxies';
...
export class UpdateLoanComponent implements OnInit {
  ...
  constructor(private service: ServiceProxy, private alertMe: AlertserviceService) { }

...
@NgModule({
  ...
  providers: [
   PerformanceManagementService,
    ...
    ToggleProjectActivityServiceProxy
  ],
  imports: [
    CommonModule,
    ComponentsModule,
